...
public class SearchDAO {
	...
	public String selectDocInfo(String docName, String deptNo) throws SQLException {
		String docNo = "";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public int multAppChk(String memNo, String docNo, String date, String time) throws SQLException {
		int result = 0;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
